  ...
  296: {
    InvoiceEscrow: {
      ...
      abi: [
        ...
        { type: "function", name: "invoices", stateMutability: "view", inputs: [{ name: "", type: "uint256" }], outputs: [{ name: "merchant", type: "address" }, { name: "token", type: "address" }, { name: "amount", type: "uint256" }, { name: "paidAmount", type: "uint256" }, { name: "dueAt", type: "uint64" }, { name: "status", type: "uint8" }, { name: "metadataHash", type: "bytes32" }] },
